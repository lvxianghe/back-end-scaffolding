...
public class UnifiedDataSourceConfig {
    ...
    public void initDataSources() {
        if (multiDataSourceProperties.getDataSource() == null ||
            multiDataSourceProperties.getDataSource().isEmpty()) {
        ...
        // 遍历配置的数据源进行初始化
        multiDataSourceProperties.getDataSource().forEach((name, config) -> {
            try {
